...
<head>
    ...
    <title>Uprise City Admin Dashboard</title>
</head>
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{route('home')}}">
                    <img src="{{asset('uprise_city/upriseimg/uprisecitylogo.png')}}" alt="" width="90px" height="90px">
                </a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ asset('uprise_city/upriseimg/circle.png') }}" alt=""
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('approved_user')}}">Approved Users</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('regular_user')}}">Regular Ticket Users</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('special_user')}}">Special Ticket Users</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('vip_user')}}">VIP Ticket Users</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('add_speaker')}}">Add Speaker</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('manage_speaker')}}">Manage Speakers</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('photo_gallery')}}">Add Photo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('manage_photo')}}">Manage Photo</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-handshake"></i>Sponsors</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/general-table.html">Add Photo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/data-tables.html">Manage Photo</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
