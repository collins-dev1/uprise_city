...
<div>
    <div>
      <h1 class="text-dark">Approved Members</h1>
      <p class="text-dark">Viewing and Managing Informations About All Approved Members</p>
    </div>
        ...
        <table class="table table-bordered" style="color: #000;">
            ...
            <tbody align="center">
                ...
                <tr>
                    ...
                    <td class="text-success fw-bold">{{$member->payment_status}}</td>
                    <td>
                        <img src="{{$member->qrcode}}" alt="" width="100px" height="100px">
                    </td>
                    <td>
