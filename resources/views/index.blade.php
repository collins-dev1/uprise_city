...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="{{asset('uprise-city/style.css')}}" />
  </head>
  <body>
      ...
      <div class="hero-grid">
        <div>
          <span class="hero-eyebrow"
            ><span class="dot"></span> Vegas Astoria Hotels GRA Onitsha,
            Nigeria</span
          >
          <h1>
          ...
          <div class="hero-actions">
            <a
              href="https://forms.gle/jDSWcwRPrVbEDwoE7"
              target="_blank"
              rel="noopener"
              class="btn btn-brass"
              >Register Now</a
          ...
          <div
            class="countdown"
            data-countdown="2026-10-31T09:00:00"
        ...
        <div class="hero-art">
          <img src="/img/heading2.jpg" width="100%" height="100%" alt="" />
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="lede-holder">
          ...
          <div style="height: 400px;">
            <img src="img/GLOBAL2026.jpeg" width="100%" height="100%" alt="" />
          </div>
        </div>
        ...
        <div
          style="margin-top: 52px; display: flex; gap: 16px; flex-wrap: wrap"
        >
          <a
            href="https://forms.gle/jDSWcwRPrVbEDwoE7"
            target="_blank"
      ...
      <div class="container">
        <div class="grid-2" style="align-items: flex-start">
          <div>
            ...
            <div>
              <img src="/img/UPRISE CITY ACADEMY.jpg" alt="">
            </div>
          </div>
          <div>
            ...
            <div class="faq-item">
              <button class="faq-q">
                <span>What will I walk away with?</span
            ...
            <div class="faq-item">
              <button class="faq-q">
                <span>Are you selling virtual tickets?</span
                ><span class="plus"></span>
              </button>
              <div class="faq-a">
                <p>
            ...
            <div class="faq-item">
              <button class="faq-q">
                <span>Can I transfer or refund my ticket?</span
                ><span class="plus"></span>
              </button>
              <div class="faq-a">
                <p>
    ...
    <section class="section--tight" style="background: var(--paper-2)">
      <div class="container center">
        <span class="kicker mx-auto" style="justify-content: center"
          >Get in touch</span
        >
        ...
        <div
          ...
          "
        >
          <a href="mailto:uprisecitynig@gmail.com" class="btn btn-ink"
            >Email Us</a
          >
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            <h4>Get in touch</h4>
            <ul>
              <li>Vegas Astoria Hotels GRA Onitsha, Nigeria, Nigeria</li>
