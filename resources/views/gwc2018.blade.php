                ...
                <div class="elementor-element elementor-element-1d02e86 e-flex e-con-boxed e-con e-parent"
                    ...
                    <div class="e-con-inner">
                        <div class="elementor-element elementor-element-5a1fd9d elementor-widget elementor-widget-heading"
                            ...
                            <div class="elementor-widget-container">
                                <h2 class="elementor-heading-title elementor-size-default">GLOBAL WEALTH CONFERENCE 2018</h2>
                            </div>
                        </div>
                        ...
                        <div class="eael-filterable-gallery-item">
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1432.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1433.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1434.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1435.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1436.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1437.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1438.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1439.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1440.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1441.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1442.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1443.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1444.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1445.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1446.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1447.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1448.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1449.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1450.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1451.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1452.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1453.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1454.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1455.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1456.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1457.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1458.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1459.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1460.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1461.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1462.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1463.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1464.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1465.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1466.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1467.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1468.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1469.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1470.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1471.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1472.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1473.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1474.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1475.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1476.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1477.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1478.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1479.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1482.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1483.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1484.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1485.JPG') }}" alt="">

                            </div> <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1486.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1487.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1489.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1490.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1491.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1492.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1493.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1494.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1495.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1496.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1497.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1498.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1499.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1500.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1501.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1502.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1503.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1504.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1505.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1506.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1508.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1509.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1510.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1511.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1512.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1513.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1514.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1515.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1516.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1517.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1518.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1519.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1520.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1521.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1522.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1523.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1524.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1525.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1526.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1527.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1528.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1529.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1530.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1531.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1532.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1533.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1534.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1535.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1537.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1538.JPG') }}" alt="">

                            </div>
                            <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1539.JPG') }}" alt="">

                            </div>
                             <div class="eael-gallery-grid">
                                <img src="{{ asset('GWC 2018/DSC_1540.JPG') }}" alt="">
